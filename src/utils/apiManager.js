class ApiManager {
    ...
    async addFriend(reqBody) {
        const url = `${this.#apiDomain}/friends/add`;
        const options = {
            mode: "cors",
            method: "POST",
            credentials: "include",
    ...
    async removeFriend(relationId) {
        const endPoint = `/delete/${relationId}`;
        const url = `${this.#apiDomain}/friends${endPoint}`;
        const options = {
            mode: "cors",
            method: "DELETE",
            credentials: "include"
    ...
    async uploadImage(reqBody) {
        const url = `${this.#apiDomain}/user/upload-image`;
        const options = {
            mode: "cors",
            method: "POST",
            credentials: "include",
    ...
    async deleteImage() {
        const url = `${this.#apiDomain}/user/delete-image`;
        const options = {
            mode: "cors",
            method: "DELETE",
            credentials: "include"
